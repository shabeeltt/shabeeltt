...
| Area | Tech |
|:---|:---|
| Frontend | React, Next.js, TypeScript, Astro, Tailwind CSS |
| Backend | Node.js, Express, REST APIs |
| Mobile | Flutter |
| Database | MongoDB, MySQL, Firebase |
| Tools | GCP, Git, Docker, Sass |
...
Pinned repositories below are personal builds and ongoing experiments.  
Each has its own README covering what it does and the decisions behind it.
...
<a href="https://buymeachai.ezee.li/shabeel_tt"><img src="https://buymeachai.ezee.li/assets/images/buymeachai-button.png" alt="Buy Me A Chai" height="35"></a>
